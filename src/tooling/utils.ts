...
export function createDebugIdSnippet(debugId: string): string {
  return `!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._agridChunkIds=e._agridChunkIds||{},e._agridChunkIds[n]="${debugId}")}catch(e){}}();`
}
...
export function determineDebugIdFromBundleSource(code: string): string | undefined {
  const match = code.match(/_agridChunkIds\[\s*(?:(?:"[^"]*")|(?:'[^']*')|\d+)\s*\]\s*=\s*"([^"]+)"/)
