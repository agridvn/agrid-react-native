...
export const sendSurveyShownEvent = (survey: Survey, agrid: Agrid): void => {
  agrid.capture('survey shown', {
...
export const dismissedSurveyEvent = (survey: Survey, agrid: Agrid): void => {
  agrid.capture('survey dismissed', {
    $survey_name: survey.name,
    $survey_id: survey.id,
    ...maybeAdd('$survey_iteration', survey.current_iteration),
    ...maybeAdd('$survey_iteration_start_date', survey.current_iteration_start_date),
...
export function Questions({
  ...
  }: // displayQuestionIndex,
  {
    ...
    if (nextStep === SurveyQuestionBranchingType.End) {
      // End the survey
      sendSurveyEvent(allResponses, survey, agrid)
      onSubmit()
    } else {
