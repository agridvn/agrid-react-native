...
import { PostHogAutocaptureElement, JsonType } from '@agrid/core'
...
export const defaultAgridLabelProp = 'ph-label'

export const autocaptureFromTouchEvent = (e: any, agrid: Agrid, options: AgridAutocaptureOptions = {}): void => {
  const {
    noCaptureProp = 'ph-no-capture',
    customLabelProp = defaultAgridLabelProp,
  ...
  if (elements.length) {
    ...
    agrid.autocapture('touch', elements, {
