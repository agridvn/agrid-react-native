...
import { Survey, SurveyQuestionBranchingType, SurveyQuestionType, SurveyType } from '@agrid/core'
  ...
  describe('Response-based branching - Rating', () => {
    ...
    it('should handle invalid rating response type gracefully', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith(
        'Agrid Debug: Expected integer response for rating question but received:',
        'invalid'
      )
    ...
    it('should handle out-of-range rating values gracefully', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('Agrid Debug: Rating response out of range for scale 5:', 0)

      // Test out-of-range high value
      result = getNextSurveyStep(survey, 0, 6)
      expect(result).toBe(2) // Should use neutral bucket and go to question 3
      expect(consoleSpy).toHaveBeenCalledWith('Agrid Debug: Rating response out of range for scale 5:', 6)
    ...
    it('should handle unsupported rating scales gracefully', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('Agrid Debug: Unsupported rating scale:', 4)
